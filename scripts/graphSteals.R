...
y_range <- range(0, d4$RATIO, d5$RATIO)
...
plot(d4$WORKTIME, d4$RATIO, type="o", col="blue", ylim=y_range,
     axes = FALSE, ann = FALSE)
lines(d5$WORKTIME, d5$RATIO, type="o", pch=22, lty=2, col="red")
axis(1, at=d4$WORKTIME, lab=d4$WORKTIME)
...
legend("topleft", y_range[2], c("Parallel Batches","Sequential Batches"),
