...
y_range <- range(0, data$FULL, data$RAW, data$RACE,data$FC)
...
lines(data$NPROC, data$RACE, type="o", pch=23, lty=3, col="green")
...
legend("topright",
       c("Full", "Raw mode", "Race (Don't wait on batches)", "Flat combining"),
