...
/* struct invoke_ds_main_catch_inlet_args {int res;}; */
...
/*  *\/ */
/* void */
/* invoke_ds_main_catch_inlet(CilkWorkerState *const _cilk_ws, */
...
/*   USE_SHARED1(invoke_ds_main_sig)[1].size = sizeof(int); */
/*   USE_SHARED1(invoke_ds_main_sig)[1].inlet = invoke_ds_main_catch_inlet; */
/*   USE_SHARED1(invoke_ds_main_sig)[1].argsize = return_size; */
...
/*   _cilk_frame->import_ds_main(_cilk_ws, args); */
/*   CILK2C_XPOP_FRAME_NORESULT(_cilk_frame,/\* return nothing *\/); */
/*   CILK2C_AFTER_SPAWN_SLOW(); */
