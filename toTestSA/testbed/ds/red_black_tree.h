...
typedef struct rb_red_blk_node {
  ...
  SinLinkList * nodes_list; //Added for the purpose of race_detect
...
//! This was implemented by Shane for the the purpose of race-detection
rb_red_blk_node * RBTreeFind(rb_red_blk_tree*,rb_red_blk_node* root,  void* key);
