...
static void _cilk_fib_slow(CilkWorkerState*const _cilk_ws,struct _cilk_fib_frame*_cilk_frame)
{
  ...
  case 1: goto _cilk_sync1;case 2: goto _cilk_sync2;case 3: goto _cilk_sync3;
  }
  n=_cilk_frame->scope0.n;
  {
    if (n < 2) {
    ...
    } else {
      {
        ...
        _cilk_frame->scope1.x=_cilk_temp3;
        if (0) {
      ...
      }
      {
        ...
        Cilk_cilk2c_after_spawn_slow_cp(_cilk_ws, &(_cilk_frame->header));
        _cilk_frame->scope1.y=_cilk_temp4;
        if (0) {
        _cilk_sync2:
          ;
        }
